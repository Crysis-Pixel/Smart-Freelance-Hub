        ...
        <>
            <div className="hero bg-base-200 min-h-screen border">
                <div className="hero-content flex-col lg:flex-row-reverse drop-shadow-sm border">
                    ...
                    <p className="py-6">
                    Discover top freelance professionals across industries and scale your projects effortlessly. 
                    Whether you’re looking to hire or seeking new opportunities, Smart Freelance Hub connects talent with innovative businesses for seamless collaboration.
                    </p>
